...
xls_convert<- function(data, project, cruise, version = "v1.0") {
    ...
    dataset_metadata <- dplyr::tibble(
                          ...
                          dataset_source = "sample analyzed by BD Influx cell sorter",
                          dataset_doi = "TBD",
                          dataset_history = "Data were analyzed using the R script FCS_Analysis available on Github (https://github.com/fribalet/FCS_analysis)",
                          dataset_description = "Influx data generated by University of Washington / Armbrust lab (kcain97@uw.edu, ribalet@uw.edu)",
                          dataset_references = "")
